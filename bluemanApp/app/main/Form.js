...
`;
  ...
  createNewFormContactHtml = `   <h2 class="form__title">CONTACT ME</h2>

  <div class="form__field" id="firstName_anchor">
      <label for="firstName">
          <span class="field__label">Nombre</span>
      </label>
      <input type="text" required="required" data-text-only="False" id="firstName" name="firstName" autocomplete=""
          aria-required="True" placeholder=""
          data-error-message="{&quot;empty&quot;:&quot;Nombre no puede estar vacio&quot;,&quot;invalid&quot;:&quot;Nombre invalido&quot;}">
  </div>

  <div class="form__field" id="lastName_anchor"><label for="lastName"><span
              class="field__label">Apellido</span></label>
      <input type="text" required="required" data-text-only="False" id="lastName" name="lastName" autocomplete=""
          aria-required="True" placeholder=""
          data-error-message="{&quot;empty&quot;:&quot;Apellido no puede estar vacio&quot;,&quot;invalid&quot;:&quot;Apellido invalido&quot;}">
  </div>

  <div class="form__field" id="email_anchor"><label for="email"><span class="field__label">Dirección de correo
              electrónico</span></label>
      <input type="email" id="email" name="email" required="required" autocomplete="" aria-required="True"
          data-error-message="{&quot;empty&quot;:&quot;Correo electrónico no puede estar vacio&quot;,&quot;invalid&quot;:&quot;Correo electrónico invalido&quot;}">
  </div>

  <div class="form__field" id="phoneNumber_anchor"><label for="phoneNumber"><span class="field__label">Numero de
              teléfono (opcional)</span> <span class="field__hint" style="display: inline-block;">con el formato
              1234567890</span></label> <input type="tel" id="phoneNumber" name="phoneNumber" autocomplete="tel"
          aria-required="False"
          data-error-message="{&quot;empty&quot;:&quot;Numero de telefono no puede estar vacio&quot;,&quot;invalid&quot;:&quot;Numero de teléfono invalido&quot;}">
  </div>

  <div class="form__field form__select">
      <label for="country">
          <span class="field__label">País de residencia</span>
      </label>
      <select id="country" required="required" name="country" aria-required="True"
          data-error-message="{&quot;empty&quot;:&quot;País de residencia no puede estar vacio&quot;,&quot;invalid&quot;:&quot;País de residencia es invalido&quot;}"
          data-type="country">
          <option value="" disabled="disabled" selected="selected">--Elige un país--</option>
  ...
  <div class="form__field form__select" style="display: none;">
      <label for="subRegion">
          <span class="field__label">Region(optional)</span>
      </label>
      <select id="subRegion" disabled="disabled" name="SubRegion"
  ...
  <div class="form__field" id="postalCode_anchor">
      <label for="postalCode">
          <span class="field__label">Zip / Postal Code</span>
      </label>
      <input type="text" required="required" data-text-only="False" id="postalCode" name="postalCode" autocomplete=""
          aria-required="True" placeholder=""
  ...
  <div class="form__field form__select">
      <label for="topic">
          <span class="field__label">Topic (optional)</span>
      </label>
  ...
  <div class="form__field">
      <label for="message">
          <span class="field__label">Drop Us A Line</span>
          <span class="field__hint"></span>
      </label>
      <textarea required="required" id="message" name="message" rows="4" aria-describedby="message" maxlength="2000"
          aria-required="True"
          data-error-message="{&quot;empty&quot;:&quot;Drop Us A Line can't be empty&quot;,&quot;invalid&quot;:&quot;Drop Us A Line is invalid&quot;}">
      </textarea>
  </div>
  ...
  <div data-no-optional-msg="true" class="form__field" id="optin_anchor">
      ...
      <div class="field__checkbox">
          ...
          <label for="optin">
              <span>
                  <p>
                      <a href="/privacy-policy">Privacy Policy</a> or <a href="/contact">contact us</a> for more
                      details.
                  </p>
              </span>
          </label>
